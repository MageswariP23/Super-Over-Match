    ...
    if(toss==1)
    {
        if(count1!=6 && w1count!=2)
        {
            ...
            else
            {
                ...
                document.getElementById("ts1").textContent = team1score;
            }
            count1++;
            updateScores();
        }
    ...
    else
    {
        if(count2!=6 && w2count!=2)
        {
            ...
            else
            {
                ...
                document.getElementById("ts2").textContent = team2score;
            }
            count2++;
            updateScores();
        }
...
{
    var team1Value = document.getElementById("c_score").children;
    ...
    var team2Value = document.getElementById("m_score").children;
